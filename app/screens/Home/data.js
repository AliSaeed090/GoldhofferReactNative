...

            {
                ...
                data: {
                    image: Images.banner62, text: [
                        'PRODUKT PROSPEKT FTV 550'], otherData: {
                            image: Images.banner62, text: [
            ...
            },
            {
                image: Images.banner63, text: '»FAKTOR« 5 | »FAKTOR« 5.5', data: {
                    image: Images.banner64, text: [
                        'PRODUKT PROSPEKT »FAKTOR« 5 | »FAKTOR« 5.5'], otherData: {
                            image: Images.banner64, text: [
            ...
            },
            {
                ...
                data: {
                    image: Images.banner66, text: [
                        'PRODUKT PROSPEKT RA 2'], videoId: "9RM0QLDti1A", otherData: {
                            image: Images.banner66, text: [
                                // 'QUICKGUIDE ZUM RA 2'
                            ], videoId: "9RM0QLDti1A",
                        }
            ...
            },
            {
                image: Images.banner67, text: 'RA 3', data: {
                    image: Images.banner68, text: [
                        'PRODUKT PROSPEKT RA 3'], videoId: "eP_YC0cr0n0", otherData: {
                            image: Images.banner68, text: [
                                // 'QUICKGUIDE ZUM RA 3'
                            ], videoId: "eP_YC0cr0n0",
                        }
            ...
            },
            {
                ...
                data: {
                    image: Images.banner70, text: [
                        'PRODUKT PROSPEKT RA 4'], videoId: "9RM0QLDti1A", otherData: {
                            image: Images.banner70, text: [
                                // 'QUICKGUIDE ZUM RA 4'
                            ], videoId: "9RM0QLDti1A",
                        }
            ...
            },
            {
                ...
                data: {
                    image: Images.banner74, text: [
                        'PRODUKT PROSPEKT »BLADES«'], videoId: "9RM0QLDti1A", otherData: {
                            image: Images.banner74, text: [
