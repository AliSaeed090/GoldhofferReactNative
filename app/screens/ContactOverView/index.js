...
const listTransportArrGerman = [
  {txt: 'TRAILSTAR', selected: false},
  {txt: 'SATTELANHÄNGER', selected: false},
  {txt: 'SCHWERLASTMODULE', selected: false},
  {txt: 'SPEZIALANWENDUNGEN', selected: false},
  {txt: 'SOFORT VERFÜGBAR', selected: false},
  {txt: 'PARTNER', selected: false},
];
const listTransportArrEnglish = [
  {txt: 'TRAILSTAR', selected: false},
  {txt: 'SEMI-TRAILERS', selected: false},
  {txt: 'HEAVY-DUTY MODULES', selected: false},
  {txt: 'SPECIAL APPLICATIONS', selected: false},
  {txt: 'IMMEDIATELY AVAILABLE', selected: false},
];
const lisrAirportEnglish = [
  {txt: 'CARGO & PUSHBACK TRACTORS', selected: false},
  {txt: 'CONVENTIONAL TRACTORS', selected: false},
  {txt: 'TOWBARLESS TRACTORS', selected: false},
  {txt: 'AIRCRAFT RECOVERY TRANSPORT SYSTEMS', selected: false},
];

const lisrAirportGerman = [
  {txt: 'FRACHT-/PUSHBACKSCHLEPPER', selected: false},
  {txt: 'KONVENTIONELLE SCHLEPPER', selected: false},
  {txt: 'STANGENLOSE SCHLEPPER', selected: false},
  {txt: 'FLUGZEUGBERGESYSTEME', selected: false},
  {txt: 'PARTNER', selected: false},
];
...
export default function ContactOverView(props) {
  ...
  const [transportArr, setTransportArr] = useState(listTransportArrGerman);

  const [airportArr, setAirportArr] = useState(lisrAirportGerman);
  useEffect(() => {
  ...
  const checkField = () => {
    ...
    else if (property.EMAIL === '' ||!validEmail(property.EMAIL)  ) {
      ...
      <ScrollView>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  alignItems: 'center',
                  backgroundColor:
                    showTransportList === true ? '#E1E1E1' : 'black',
                  padding: 10,
                }}>
                <Text headline bold whiteColor>
                  TRANSPORT
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  justifyContent: 'center',
                  alignItems: 'center',
                  backgroundColor: showAirPort === true ? '#E1E1E1' : 'black',
                  padding: 10,
                }}>
                <Text headline bold whiteColor>
                  AIRPORT
        ...
        <View
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, VORNAME: txt})}
              value={property.VORNAME}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, NACHNAME: txt})}
              value={property.NACHNAME}
              style={{backgroundColor: 'transparent', fontWeight: 'bold'}}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, EMAIL: txt})}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, FIRMA: txt})}
              value={property.FIRMA}
              style={{backgroundColor: 'transparent', fontWeight: 'bold'}}
          ...
          <View
            ...
            <TextInput
              ...
              onChangeText={txt => setProperty({...property, MOBILNUMMER: txt})}
              value={property.MOBILNUMMER}
              style={{backgroundColor: 'transparent', fontWeight: 'bold'}}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, ADRESSE: txt})}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt => setProperty({...property, LAND: txt})}
              value={property.LAND}
              style={{backgroundColor: 'transparent', fontWeight: 'bold'}}
          ...
          <View
            ...
            <TextInput
              onChangeText={txt =>
                setProperty({...property, MEINANLIEGEN: txt})
              }
              value={property.MEINANLIEGEN}
              style={{backgroundColor: 'transparent', fontWeight: 'bold'}}
              placeholder={t('MY_REQUEST')}
              placeholderTextColor="white"
            />
          </View>
          ...
          <TouchableOpacity
            ...
            <Text whiteColor>{t('Privacy_terms')}</Text>
          </TouchableOpacity>
